...
2. tDCS - транскраниальная стимуляция постоян­ным током (в этом режиме полярность имеет критическое значение, при смене кабеля проверяйте полярность! см. https://github.com/e-kolkhoz/tRNS/blob/1.1.0-duo/CALIBRATION.md)
...
- Гнезда L и R (DC-011 2.5х0.7 мм), подходит так же для кабеля 2.35х0.7 мм после срезания с кабеля пластикового кожуха, при замене кабеля с комплектного на другой проверяйте полярность (см. https://github.com/e-kolkhoz/tRNS/blob/1.1.0-duo/CALIBRATION.md)!
...
- `Калибровка` - внутри раздел меню где устанавливаются `DAC к/мА L и R: XXXXX` - сколько единиц, пропорциональных напряжению должен выдавать DAC, чтобы получить 1мA целевого тока, см. https://github.com/e-kolkhoz/tRNS/blob/1.1.0-duo/CALIBRATION.md.
...
4. Устройство перезагрузится в режим прошивки, при подключении компьютера по USB-C, на компьютере появится накопитель LOLIN3MBOOT.
5. Чтобы было легче откатится на старую прошивку, скопируйте CURRENT.UF2 себе на компьютер с LOLIN3MBOOT.
