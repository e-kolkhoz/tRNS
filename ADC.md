Обратная связь токовая, униполярная, с помощью сдвига 1.25 V
...
нужно набивать в буфер i2s непрерывно, если позволяет S3, то с оверсемплингом, дизероингом и фильтрацией
