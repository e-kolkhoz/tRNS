...
6. Вбиваем ближайшее доступное значение, получаем `DAC коды/мА: 11300`, проверяем снова с пункта 1.
Полярность. Если при корректном подключении видим отрицательные значения миллиамперов, то кроме калибровки в `Настройки` нажимаем на пункт `Полярность: Инв. / Норм.` и проверяем снова с пункта 1.
# Прошивка
...
Если режим обновления был выбран случайно и у вас нет файлов для обновления, можно можно после пункта 5 скопировать CURRENT.UF2 с компьютера на S2MINIBOOT вместо пункта 6.
